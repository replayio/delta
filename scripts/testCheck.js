const { updateCheck, createCheck } = require("../lib/github");
const githubFixtures = require("../test/fixtures/github");
...
(async () => {
  if (false) {
    ...
    // console.log(githubFixtures.queued_workflow);

    const { workflow_job, repository } = githubFixtures.queued_workflow;
    if (!workflow_job) {
      return;
    }
